...
2. **이 스킬 폴더 내** `domains/` 의 하위 항목을 검색하여 사용 가능한 도메인 목록을 확인한다 (예: [domains/software-dev/](domains/software-dev/))
...
초기화 완료 후, [phases/01_direction.md](phases/01_direction.md)를 로드하여 방향 설정을 시작한다.
